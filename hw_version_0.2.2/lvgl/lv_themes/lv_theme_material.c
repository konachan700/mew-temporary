...
static void btn_init(void)
{
    ...
    pr.body.main_color.full = 0xF800; //lv_color_hsv_to_rgb(_hue, 90, 60);
    ...
    tgl_pr.body.main_color.full = 0xF800; //lv_color_hsv_to_rgb(_hue, 95, 40);
...
static void btnm_init(void)
{
    ...
    lv_style_copy(&pr, &rel);
    pr.glass = 0;
    pr.body.main_color.full = 0xF800; // LV_COLOR_HEX3(0xddd);
    pr.body.grad_color = pr.body.main_color;
    ...
    lv_style_copy(&tgl_pr, &tgl_rel);
    tgl_pr.body.main_color.full = 0xF800; // lv_color_hsv_to_rgb(_hue, 95, 65);
    tgl_pr.body.grad_color = tgl_pr.body.main_color;
